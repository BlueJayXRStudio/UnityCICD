...
with open(base_resolver.resolved("store_deployment_data/version_info.yml"), "r") as f:
...
with open(base_resolver.resolved("store_deployment_data/version_info.yml"), "w") as f: 
